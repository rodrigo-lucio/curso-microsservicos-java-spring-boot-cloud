...
- Nesta branch, todos os projetos estão configurados para rodar em ambiente docker
...
- OBS: Não passar o parâmetro --name quando for escalar e rodar mais de uma instância. Isso vale para: hr-worker, hr-user, hr-payroll e hr-oauth. Rodando mais de uma instância, a porta é gerada de forma aleatória e o balanceamento de carga é feito automaticamente.
